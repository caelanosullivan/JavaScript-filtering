// Get references to tbody element, input fields, and buttons
...
// Add an event listener to the searchButton and resetButton; call functions on click
$searchBtn.addEventListener("click", handleSearchButtonClick);
$resetBtn.addEventListener("click", handleResetButtonClick);

// Populate filteredData with dataSet
...
function handleSearchButtonClick() {
  // Format user's input by removing leading and trailing whitespace
...
// Reset data and clear search form after a search
